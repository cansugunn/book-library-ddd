...
public class UserApplicationServiceImpl implements UserApplicationService {
    ...
    public FindUserResponse findUser(String username, String password) {
        return userRepository.findByUsernameAndPassword(username, passwordEncryptor.encrypt(password))
                .map(userDataMapper::toFindUserResponse)
                .orElseThrow(() -> new UserNotFoundException("User with provided credentials does not exist!"));
    }
