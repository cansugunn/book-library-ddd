package com.finalproject.infrastructure.swing.persistence.jdbc.config;
...
public class DatabaseConfig {
    private static final String SWING_DB_URL = env("SWING_DB_URL", "jdbc:mysql://localhost:3306/mylibrary");
    private static final String SWING_DB_USER = env("SWING_DB_USER", "root");
    private static final String SWING_DB_PASSWORD = env("SWING_DB_PASSWORD", "root");
